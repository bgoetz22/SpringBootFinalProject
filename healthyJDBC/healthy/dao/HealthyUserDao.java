...
//         // @formatter:on     
 ...
 // @formatter:on
  ...
  public Exercise createExercise(Exercise exercise) {
    ...
    params.addValue("muscle_group", exercise.getMuscleGroup());
    
    jdbcTemplate.update(sql, params, holder);
    exercise.setID((int) holder.getKey());
    return exercise;
  }
  ...
  public Workout createWorkout(Workout workout) {
    ...
    KeyHolder holder = new GeneratedKeyHolder();
    MapSqlParameterSource params = new MapSqlParameterSource();
    params.addValue("sets_qty", workout.getSets());
    params.addValue("reps_qty", workout.getReps());
    params.addValue("date_completed", workout.getDateCompleted());
    
    jdbcTemplate.update(sql, params, holder);
    workout.setID((int) holder.getKey());
    return workout;
  }
  ...
  public Workout deleteWorkout(Workout workout) {
    String sql = "DELETE from workout (sets_qty, resp_qty, date_completed) values(:sets_qty, :reps_qty, :date_completed)";
    KeyHolder holder = new GeneratedKeyHolder();
    MapSqlParameterSource params = new MapSqlParameterSource();
    params.addValue("sets_qty", workout.getSets());
    params.addValue("reps_qty", workout.getReps());
